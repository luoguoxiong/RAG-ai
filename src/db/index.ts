...
export async function setupRls(): Promise<void> {
  ...
  await db.execute(sql`
    ...
    DECLARE t text;
    BEGIN
      FOREACH t IN ARRAY ARRAY['documents','document_versions','chunks','index_status','jobs','outbox','entities','entity_mentions','relations','communities','community_members','eval_datasets','eval_queries','eval_runs','eval_run_results']
      LOOP
